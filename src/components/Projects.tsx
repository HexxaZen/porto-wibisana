    ...
    <section id="projects" className="py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Project 2 */}
          <div className="bg-slate-800 bg-opacity-50 rounded-xl overflow-hidden border border-blue-900 card-hover" data-aos="fade-up" data-aos-delay="200">
            <div className="h-48 bg-blue-900 relative overflow-hidden">
          ...
          {/* Project 3 */}
          <div className="bg-slate-800 bg-opacity-50 rounded-xl overflow-hidden border border-blue-900 card-hover" data-aos="fade-up" data-aos-delay="300">
            <div className="h-48 bg-blue-900 relative overflow-hidden">
